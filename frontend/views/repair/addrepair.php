            ...
            <div class="row">
                <div class="col-lg-5">
                    <form  action="<?=Yii::$app->urlManager->createUrl(['repair/add'])?>" method="post">
                        <div class="form-group field-contactform-name required">
                            <label class="control-label" for="contactform-name">维修名称*</label>
                            <input type="text" class="form-control" name="repair_name"   autofocus aria-required="true">
                        </div>
                        <div class="form-group field-contactform-subject required">
                            <label class="control-label" for="contactform-subject">维修类型*</label>
                            <span class="selectList">
                            <select class="form-control default-first" name="repair_goods_type" aria-required="true">
                        ...
                        <div class="form-group field-contactform-name required">
                            ...
                            <input type="text" class="form-control" name="repair_price"   autofocus aria-required="true" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')">
                        </div>
                        <div class="form-group field-contactform-name required">
                            <label class="control-label" for="contactform-name">成本价格*</label>
                            <input type="text" class="form-control" id="goods_price" name="goods_price"   autofocus aria-required="true" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')">
                        </div>
...
//初始化levelsecond
        ...
        $(".default-second").change(function(){
            var price = $(this).find("option:selected").attr('data-price');
            $('#goods_price').val(price);
        })
        $(".default-first").change(function(){
            $('#goods_price').val('');
        })
    });
